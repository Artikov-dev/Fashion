...
class Cart(db.Model):
    ...
    # Relationship
    items = db.relationship('CartItem', backref='cart', lazy='select', cascade='all, delete-orphan')
    ...
    def clear(self):
        ...
        CartItem.query.filter_by(cart_id=self.id).delete(synchronize_session=False)
